...
THEGRAPH_API_KEY: Final[str] = os.getenv("THEGRAPH_API_KEY", "")    
if not THEGRAPH_API_KEY:
    raise ValueError("THEGRAPH_API_KEY environment variable is not set. Please check your .env file.")


# RPC_WEBSOCKET_URL: Final[str] = os.getenv("RPC_WEBSOCKET_URL", "")
# if not RPC_WEBSOCKET_URL:
#    raise ValueError("RPC_WEBSOCKET_URL environment variable is not set. Please check your .env file.")

RPC_WEBSOCKET_URL: Final[str] = f"wss://arbitrum-mainnet.infura.io/ws/v3/{INFURA_API_KEY}"

# Redis Configuration
REDIS_HOST: Final[str] = os.getenv("REDIS_HOST", "localhost")
REDIS_PORT: Final[int] = int(os.getenv("REDIS_PORT", "6380"))
REDIS_PASSWORD: Final[Optional[str]] = os.getenv("REDIS_PASSWORD")
REDIS_POOL_LOGS_PREFIX: Final[str] = "pool_logs:"  # Prefix for pool update logs in Redis
REDIS_LOGGING_ENABLED: Final[bool] = os.getenv("REDIS_LOGGING_ENABLED", "False").lower() == "true"  # Flag to enable/disable Redis logging
